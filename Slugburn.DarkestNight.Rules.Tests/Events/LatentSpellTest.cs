    ...
    public class LatentSpellTest
    {
        ...
        public void LatentSpell_NoEffect(int roll)
        {
            TestScenario
                ...
                .Given.Hero().HasDrawnEvent("Latent Spell")
        ...
        public void LatentSpell_DestroyBlight()
        {
            TestScenario
                ...
                .Given.Location("Village").HasBlights("Confusion", "Vampire")
                .Given.Location("Castle").HasBlights("Desecration")
                .When.Player.SelectsEventOption("Continue")
        ...
        public void LatentSpell_DrawPower()
        {
            TestScenario
                ...
                .Given.Hero().PowerDeck("Leech Life")
                .When.Player.SelectsEventOption("Continue")
