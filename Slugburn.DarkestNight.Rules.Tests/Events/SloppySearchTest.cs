    ...
    public class SloppySearchTest
    {
        ...
        public void SloppySearch_SpendGrace(int roll)
        {
            TestScenario
                ...
                .When.Hero.DrawsEvent("Sloppy Search")
                .When.Player.SelectsEventOption("Roll", x => x.Rolls(roll))
                .Then.Player.Event.ActiveRow("Spend 1 Grace or lose 1 Secrecy").HasOptions("Spend Grace", "Lose Secrecy")
        ...
        public void SloppySearch_NoGraceToSpend()
        {
            TestScenario
                ...
                .Then.Player.Event.ActiveRow("Spend 1 Grace or lose 1 Secrecy").HasOptions("Lose Secrecy");
        }
    }
}