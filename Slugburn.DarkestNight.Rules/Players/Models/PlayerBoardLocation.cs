...
{
    public class PlayerBoardLocation
    {
        public PlayerBoardLocation(Game game, Space space)
        {
            ...
            Blights = PlayerBlight.Create(space.Blights);
        }
        ...
        public List<PlayerBlight> Blights { get; set; }
